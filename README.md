...
|FacebookShareButton|__`appId`__: The Facebook app ID (string)|__`title`__: Title of the shared page (string)<br/>__`description`__: Description of the shared page (string)<br/>__`picture`__: The picture attached to the post (min. size 200x200 px) (string)<br/>__`caption`__: Description of the link (string) |
|GooglePlusShareButton|-|-|
